...
class Publisher(SQLModel, table=True):
    ...
    books: List["models.Book"] = Relationship(back_populates="publisher", sa_relationship_kwargs={"lazy": "selectin"})
    ...
    def __repr__(self):
        return f"<Publisher {self.first_name} {self.last_name} ({self.email})>"